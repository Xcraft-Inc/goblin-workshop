...
Goblin.registerQuest(goblinName, 'create', function* (
  ...
  // TODO: Instanciate prefilter entities, create view of prefilters by table ?
...
Goblin.registerQuest(goblinName, 'changePrefilterName', function* (
  quest,
  prefilterId,
  name
) {
...
Goblin.registerQuest(goblinName, 'savePrefilter', function* (quest) {
  const state = quest.goblin.getState();
  const prefilterId = state.get('selectedPrefilterId');
  if (!prefilterId) {
    return;
  }
