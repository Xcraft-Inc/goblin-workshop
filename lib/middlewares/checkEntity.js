...
function checkEntity(entity, reporter, types, options) {
  ...
  if (
    ...
    for (const [prop, conf] of Object.entries(configuration.summaries)) {
      ...
      if (
        !Object.prototype.hasOwnProperty.call(entity['meta']['summaries'], prop)
      ) {
        report(reporter, {
          topic: 'missing-in-entity',
          entityId: entity.id,
  ...
  if (
    ...
    for (const [prop, conf] of Object.entries(configuration.sums)) {
      ...
      if (!Object.prototype.hasOwnProperty.call(entity['sums'], prop)) {
        report(reporter, {
          topic: 'missing-in-entity',
          entityId: entity.id,
          path: `sums.${prop}`,
  ...
  return {
    entityId: entity.id,
    rootAggregateId: entity.meta ? entity.meta.rootAggregateId : null,
    rootAggregatePath: entity.meta ? entity.meta.rootAggregatePath : null,
    entityFixPatch,
    propsToRemove,
    pointerToRemove,
    needRehydrating,
