...
module.exports = config => {
  ...
  Goblin.registerQuest(goblinName, 'create', function*(
    ...
    quest.goblin.setX('workitemCreateParams', {
      desktopId,
      entityId,
      entity,
      parentEntity,
  ...
  Goblin.registerQuest(goblinName, 'subscribe-to-entity', function(quest) {
    ...
    if (mode !== 'backend' || enable['buttons']) {
      entitySubs.push(
  ...
  Goblin.registerQuest(goblinName, 'after-create', function(quest) {
    ...
    const loadGraphParams = quest.goblin.getX('loadGraphParams');
    const workitemCreateParams = quest.goblin.getX('workitemCreateParams');
  ...
  Goblin.registerQuest(goblinName, 'after-load', function*(quest) {
    const entity = quest.goblin.getX('loadedEntity');
    const mode = quest.goblin.getX('mode');
