...
function builder(config) {
  ...
  Goblin.registerQuest(goblinName, 'create', function*(
    ...
    if (withGraph) {
      quest.goblin.setX('loadGraphParams', withGraph);
    }
  ...
  Goblin.registerQuest(goblinName, 'after-create', function*(quest) {
    ...
    const withGraph = quest.goblin.getX('loadGraphParams');
    if (withGraph) {
      quest.evt('entity-loadgraph-requested', {
        entity: quest.goblin.getState(),
        desktopId: quest.getDesktop(),
      });
    }
  ...
  // Load graph
  Goblin.registerQuest(goblinName, 'load-graph', function*(quest, next) {
