...
function* checkNewEntity(quest, from, entityName, entity) {
  ...
  checkEntity.checkEntity(entity, from, reporter, null, [
    'check-value-fields',
...
function* checkSummaries(quest, from, entityName, summaries) {
  ...
  checkEntity.checkEntity(entity, from, reporter, null, ['check-only-meta']);
...
function* checkSums(quest, from, entityName, sums) {
  ...
  checkEntity.checkEntity(entity, from, reporter, null, ['check-only-sums']);
